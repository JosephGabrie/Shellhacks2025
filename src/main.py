...
from director_agent.agent_folder.banking_agent.agent import notification_service_agent  # <-- Updated import
...
async def main_async():
    ...
    runner = Runner(
        agent=notification_service_agent,
        app_name=APP_NAME,
        session_service=session_service,
    )

    # ===== PART 5: Interactive Conversation Loop =====
    print("\nWelcome to Notification Service Chat!")
